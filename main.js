...
var director1 = new profesionales_1.Proffesional("Mel Gibson", 64, "Masculino", 78, 177, "Negro", "Azul", "Blanco europeo", false, "Estadounidense", 2, "Director");
var escritor1 = new profesionales_1.Proffesional("Joanne Rowling", 55, "Femenino", 65, 165, "Rubio", "verdoso", "Blanco europeo", false, "Britanica", 0, "Escritora");
...
var movie2 = new peliculas_1.Movie("Pixels", 2015, "Estadounidense", ["Fantasia", "comedia"]);
...
var movie3 = new peliculas_1.Movie("Avengers:Endgame", 2019, "Estadounidense", ["Superheroes", "Accion", "Ciencia Ficcion"]);
...
var movie4 = new peliculas_1.Movie("Las aventuras de Tadeo Jones", 2012, "Española", ["Animacion", "Aventura", "Comedia", "Infantil"]);
